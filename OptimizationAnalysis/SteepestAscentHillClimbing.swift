//
//  SteepestAscentHillClimbing.swift
...
class SteepestAscentHillClimbing {
    ...
    class func steepestAscentHillClimbing(fitFunc : [Double] -> Double?,
        Nd : Int,
        Nt : Int,
        lowerBound : Int,
        upperBound : Int,
        ...
        -> AverageReport?
    {
        ...
        for _ in 0..<runNTimes {
            if let tempReport = steepestAscentHillClimbing(fitFunc, Nd: Nd, Nt: Nt, lowerBound: lowerBound, upperBound: upperBound, lowerChange: lowerChange, upperChange: upperChange, numTweaks: numTweaks, getDataset: getDataset, tweak: tweak) {
